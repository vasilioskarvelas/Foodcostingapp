    ...
    <div className="p-5 md:p-8 max-w-3xl mx-auto space-y-6">
      ...
      <Section icon={<Scale className="w-4 h-4" />} title="Business">
        <div className="grid grid-cols-2 gap-3">
          ...
          <label className="block"><span className="text-xs font-medium text-neutral-500">GST rate %</span>
            <div className="flex items-center gap-1 mt-0.5">
              <input type="number" step="0.1" value={Math.round((form.tax_rate ?? 0.1) * 1000) / 10} onChange={(e) => setForm({ ...form, tax_rate: (Number(e.target.value) || 0) / 100 })} className="input" />
